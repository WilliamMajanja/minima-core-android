...
public class MinimaAPI {
    ...
    private Hashtable<String, MinimaAPIListener> mResponseHandlers = new Hashtable<>();

    private MinimaAPIReceive mMinimaAPIReceiver;
    ...
    public void onDestroy(){
        try{
            ...
            MinimaAPILogger.log("Error unregistering receiver: "+exc);
        }
    }
