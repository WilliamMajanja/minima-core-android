...
public class MainActivity extends AppCompatActivity implements ServiceConnection, MinimaServiceListener {
    ...
    AlertDialog mShutdownDialog = null;
...
//                return true;
    ...
    public void shutdownMinima(){
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mShutdownDialog = new AlertDialog.Builder(MainActivity.this)
                        .setTitle("Minima Shutting down..")
                ...
                mFooterLeft.post(new Runnable() {
                    ...
                    public void run() {
                        try{
                            ...
                            logger.log("Footer keys error: "+exc);
                        }
                    }
                });
            }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        mMinimaService.setServiceListener(this);
